export const assets = {
  ...
  bomb: {
    // Spritesheet configuration for animated bomb
    spritesheet: 'assets/BOMB.png',
    frameWidth: 16,     // actual content width (16x16 for each bomb)
    frameHeight: 16,    // actual content height
    // Offset to account for the 3px borders on sides/top
    sheetOffsetX: -1,
    sheetOffsetY: 0,
    // Rendering settings
    renderScale: 1.2,   // slightly smaller than player
    renderOffsetX: 0,
    renderOffsetY: 0,
    globalFrameTrim: 0, // no trimming needed
    forceGlobalFrameTrim: false,
    fps: 6,             // animation speed (adjust to taste)
    // Animation frames: 3 bomb frames in a single row
    animations: {
      "idle": {
        "default": { "row": 0, "start": 0, "count": 3 }
      }
    }
  },
  explosion: {
    spritesheet: 'assets/newFire.png', // Update to your new filename
    frameWidth: 48,
    frameHeight: 48,
    sheetOffsetX: 0,
    sheetOffsetY: 0,
    ...
    fps: 12,
    animations: {
      "center":      { "default": { "row": 0, "start": 0, "count": 7 } },
      "middle":      { "default": { "row": 1, "start": 0, "count": 7 } }, // Straight beams
